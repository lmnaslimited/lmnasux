                    ...
                    <div className="col-span-1 md:col-span-2 md:border-b-2 ">
                        <div className="md:w-1/2 ">
                            {products.products.slice(0, 1).map((product) => (
                                <Cardtype key={product.title} src={product.image} title={product.title} subTitle={product.subTitle} />
                            ))}
                        </div>
                    </div>
                    <div className="col-span-1 lg:col-start-2 md:border-r-2">
                        {products.products.slice(1, 2).map((product) => (
                            <Cardtype key={product.title} src={product.image} title={product.title} subTitle={product.subTitle} />
                        ))}
                    </div>
                    <div className=" col-span-1 lg:col-start-3">
                        {products.products.slice(2, 3).map((product) => (
                            <Cardtype key={product.title} src={product.image} title={product.title} subTitle={product.subTitle} />
                        ))}
                    </div>
                </div>
