...
export default function Homeservices({ services }) {
    return (
        <Container>
            <section className="my-24 bg-th-background-primary ">
                <div className="items-center lg:mt-12 not-sr-only lg:sr-only">
                    <h1 className="text-2xl text-center md:text-3xl font-bold md:font-sans md:pt-0 md:mt-12 lg:ml-12 text-center  antialiased uppercase">{services.title}</h1>
                </div>
