...
export default function hero({hero}) {
  return (
    <Container>
<section className="bg-white text-th-primary-dark lg:my-32 lg:mx-32 xl:mx-10 2xl:mx-16">
    <div className="grid max-w-screen-xl py-8 lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12 ">
        ...
        <p className="max-w-2xl mb-6 font-normal text-th-text-medium lg:mb-8 -mt-12 md:text-md xl:text-lg">{hero.title}</p>
            ...
            <a href="#" className="inline-flex items-center justify-center px-5 py-3 mt-10 md:text-lg font-normal text-center shadow-md rounded-lg text-th-text-light bg-th-background-cta">
             {hero.link}  
            </a> 
        </div>
        <div className=" lg:mb-16 lg:col-span-7 xl:col-span-7 lg:flex w-full h-full lg:-mt-16 lg:-ml-0 xl:-mt-16 xl:ml-52 2xl:ml-24">
            <Image alt="" width="1400" height="800" src="/hero/women-hero-1400x800.gif"></Image>
        </div>                
    </div>
</section>
</Container>
