...
export default function Contactus({contactus})
{
    return(
        <div>
        <Layout>
        <div className="md:h-80 w-full bg-pink-50">

        </div>
            <Container>
            <section class="bg-white py-20 lg:py-[120px] overflow-hidden relative z-10 bg-blue-50 px-6 md:-mt-44 md:mx-10 lg:mx-20 xl:mx-1">
   <div class="container">
