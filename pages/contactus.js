...
function MyApp() {
  ...
  <div class="container py-12 lg:-ml-32 flex flex-col lg:flex-row bg-white">
    <div class="lg:w-3/4 md:w-full bg-white rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
     <Image src="/contactus/working-women6123x4082.png" width="6000" height="4000" alt="" />
    </div>
    <div class="lg:w-1/2 md:w-full bg-blue-50 flex flex-col md:ml-auto w-full md:py-8 md:px-12 mt-8 md:mt-0">
