...
export default function Industrycard({title, subTitle, src, href, linkname}){
    return(
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center space-y-6 lg:space-y-0">
                ...
                <div className=" flex flex-col sm:flex-row jusitfy-center items-center sm:space-x-5 xl:space-x-8 space-y-4 sm:space-y-0 lg:w-3/4 xl:w-full">
                    <div className="hidden lg:block">
                        <Image width="200" height="200"  src={src} alt="" />
                    </div>
        ...
        <div className="px-4 md:py-12 py-8 my-40">
            <div className="lg:flex items-center justify-between">
            <div className="lg:w-full lg:mt-0 mt-8 hidden lg:block">
                    <div className="w-full h-full">
                    <Image width="200" height="200" className="hidden lg:block" src={src} alt="" />
                        <Image width="200" height="200" className="w-80 sm:w-auto lg:hidden" src={src} alt="" />
                    </div>
            ...
            <div className="lg:w-full xl:w-full lg:ml-12 flex flex-col justify-start items-start">
                    ...
                    <div className="lg:w-full lg:mt-0 mt-8 lg:hidden block">
                    <div className="w-full h-full ">
                    <Image width="200" height="200" className="hidden lg:block" src={src} alt="" />
                        <Image width="200" height="200" className="w-80 sm:w-auto lg:hidden" src={src} alt="" />
                   </div>
