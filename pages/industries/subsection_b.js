                        ...
                        <div className="flex flex-wrap flex-row-reverse items-center">
                            <div className="md:w-1/2 lg:w-2/3 w-full lg:pl-20 md:pl-10 sm:pl-0 pl-0">
                                <div className="py-2 text-color">
                                    <h1 className="text-center font-bold text-xl lg:text-3xl">{title}</h1>
                                    <h2 className="text-center text-lg lg:text-xl leading-7 py-8">{subtitle}</h2>
                                    <div className="justify-center flex items-center cursor-pointer pb-4 md:pb-0">
                                        <h3 className="f-f-r text-lg lg:text-2xl font-semibold underline text-indigo-700">{linkName}</h3>
                                        <div className="pl-2">
