...
function Index({title, src, card_title, subTitle}) {
    return (
<section className="mb-32 text-gray-800 text-center mt-24">
  <h2 className="text-3xl font-bold mb-12 uppercase">{title}</h2>
  <p className="text-lg xl:px-52 mb-32 text-center">{subTitle}</p>

  <div className="grid  md:grid-cols-3 mx-12 gap-12 mt-40">
    <div className="mb-24 md:mb-0">
      <div className=" w-full h-full border-2">
        <div className="flex justify-center">
          <div className="flex justify-center -mt-20 w-40 h-40 lg:w-1/2 lg:h-1/2 bg-blue-50 rounded-full mx-auto">
