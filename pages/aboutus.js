...
<a href="#" class="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row justify-center lg:ml-32 xl:ml-36 lg:w-3/4">
    <div class="md:object-cover w-3/4 h-3/4 rounded-t-lg md:h-auto md:w-full md:rounded-none md:rounded-l-lg">
    <Image width="160" height="160" src="/aboutus/about-640x640.gif" alt="" />
        </div>
    <div class="flex flex-col justify-between p-4 leading-normal bg-pink-50 md:mx-4 my-4">
        <h1 class="mb-2 text-3xl font-bold tracking-tight text-gray-800">About Us</h1>
        <p class="mb-3 text-lg font-normal text-gray-800">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.
...
<div className="w-full mt-44 ">
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5 border-2">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div className="px-6 mt-16 ">
                                    ...
                                    <p className="text-center text-gray-800 text-base pt-3 font-normal">The CEO's role in raising a company's corporate IQ is to establish an atmosphere that promotes knowledge sharing and collaboration.</p>
        ...
        understand the difference between right and wrong.
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-6 gap-4 mx-12 xl:mx-0 mb-24 md:mb-36">
                <div className="col-span-1 w-full h-full border-2 px-8 shadow-xl rounded-lg bg-pink-50 py-24">
                <h1 className="font-bold text-lg pb-1"></h1>
                <p className="text-gray-800 pt-3 font-normal text-center">  </p>
            </div>
            <div className="col-span-1 w-full h-full border-2 px-8 shadow-xl rounded-lg md:mt-12 xl:mt-12 bg-blue-50 py-24">
            ...
            <div className="col-span-1 w-full h-full border-2 px-8 shadow-xl rounded-lg xl:-mt-12 bg-pink-50 py-24">
                <h1 className="font-bold text-lg lg:text-xl text-center pb-1"></h1>
                <p className="text-center text-gray-800 text-base pt-3 font-normal"> </p>
            </div>
            <div className="col-span-1 w-full h-full border-2 px-8 shadow-xl rounded-lg xl:mt-12 bg-blue-50 py-24">
                <h1 className="font-bold text-lg lg:text-xl text-center pb-1"></h1>
                <p className="text-center text-gray-800 text-base pt-3 font-normal"></p>
            </div>
            <div className="col-span-1 w-full h-full border-2 px-8 shadow-xl rounded-lg md:mt-12 xl:-mt-12 bg-pink-50 py-24">
                <h1 className="font-bold text-lg lg:text-xl text-center pb-1"></h1>
                <p className="text-center text-gray-800 text-base pt-3 font-normal"> </p>
            </div>
            <div className="col-span-1 w-full h-full border-2 px-8 shadow-xl rounded-lg bg-blue-50 py-24 py-24">
                <h1 className="font-bold text-lg lg:text-xl text-center pb-1"></h1>
                <p className="text-center text-gray-800 text-base pt-3 font-normal"></p>
            </div>
            </div>
