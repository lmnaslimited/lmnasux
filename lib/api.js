...
const homepricing = {
    pricing:
        [
            { title: 'E-COMMERCE', subTitle: '72/mo', image: '/pricing/coin-640x640.gif', linkName: "button", href:"/pricing/erp" },
            { title: 'RETAIL', subTitle: '72/mo', image: '/pricing/coin-640x640.gif', linkName: "button", href:"/pricing/ecommerce"},
            { title: 'DISTRIBUTION', subTitle: '72/mo', image: '/pricing/coin-640x640.gif', linkName: "button",href:"/pricing/digital marketing" }
...
const services=[
    {
        ...
        subTitle:"An ERP system can streamline your entire organization and put your data all in one place, enabling more accurate reporting and a more efficient, collaboration-based and data-driven work environment",  
        image:"/product/erp-640x640.gif",
        card_title:"Flexible",
        serviceMeta:{
            meta:
            [
...
const pricing=[
    {
        ...
        option_a:{price_title:"Free",
        price_subTitle:"Unlimited products features and dedicated support channels",
        linkName:"BUY NOW",
        href:"/products/"} ,
        option_b:{price_title:"Premium",
        price_subTitle:"Unlimited products features and dedicated support channels",
        linkName:"BUY NOW",
        href:"/products/"} ,
        option_c:{price_title:"ADVANCED",
        price_subTitle:"Unlimited products features and dedicated support channels",
        linkName:"BUY NOW",
        href:"/products/"} ,
        priceMeta:{
